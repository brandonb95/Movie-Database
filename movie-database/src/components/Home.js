...
<div className="movie-filter-container">
    ...
    <section className="movie-list">
          <input onChange={changeFilter} type="radio" name="movies" id="popular" value="popular" />
          <label for="popular">Popular</label>
          <input onChange={changeFilter} type="radio" name="movies" id="now-playing" value="now_playing" /> 
          <label for="now-playing">Now Playing</label>
          <input onChange={changeFilter} type="radio" name="movies" id="top-rated" value="top_rated" /> 
          <label for="top-rated">Top Rated</label>
          <input onChange={changeFilter} type="radio" name="movies" id="upcoming" value="upcoming" />  
